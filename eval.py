...
tf.flags.DEFINE_string("checkpoint_dir", r"./runs/1516170582/checkpoints", "Checkpoint directory from training run")
...
raw = []
with open ('./data/train.txt','r',encoding = 'utf-8') as r1:
